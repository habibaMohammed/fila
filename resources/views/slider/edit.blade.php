    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center image-form">
                <form class="col-md-6 image-uplode d-inline-block border shadow-lg rounded p-2 mt-5" action="{{ route('slider.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="caption" value="{{ $slider->caption }}"  class="form-control" placeholder="Caption">
            </div>
        </div>
                    <div class="m-5">
